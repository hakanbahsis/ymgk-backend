...
namespace DataAccess.Concrete.EntityFramework.Context
{
    public class ContextDb : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=DESKTOP-NBOA8Q1\Lenovo;Database=eReconciliationDbNew;Integrated Security=false;Trusted_Connection=SSPI;Encrypt=false;TrustServerCertificate=true");            
        }
